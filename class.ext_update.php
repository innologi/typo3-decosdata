...
class ext_update extends ExtUpdateAbstract {
	...
	protected $lang = array(
		...
		'dirMoveAutomatic' => 'Please move, copy or symlink the file-directory \'<code>%1$s</code>\' so that it is available at \'<code>%2$s</code>\'. The updater will automatically detect this at the next run.',
		'dirMoveManual' => 'Unfortunately, the updater cannot detect the corresponding file-directory in the document path. (assumed to be \'<code>%1$s</code>\') Please move, copy or symlink it so that it becomes available within the XML Import path, then change the \'<code>%2$s</code>\' record manually to reflect this.',
		'falMigrateSuccess' => 'Migrated %2$d \'<code>%1$s</code>\' records to FAL.',
		'falMigrateFail' => 'Cannot migrate file to FAL.',
		'falMigrateFailCorrect' => 'You should correct this issue. You can move the file to a location within e.g. \'<code>%1$s</code>\' and will have to correct the path within the \'<code>%2$s</code>\' record.',
		'falMigrateFailDelete' => 'The file registration will hence not be migrated.',
		'falMigrateFailTitle' => '%1$s FAL migration: <code>%2$s</code>',
		'migrateManual' => 'Due to necessary core changes between extensions, an automated migration of %1$s is not possible. %2$s: <code>%3$s</code>',
